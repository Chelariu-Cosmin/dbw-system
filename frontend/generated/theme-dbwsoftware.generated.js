...
import stylesCss from 'themes/dbwsoftware/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_dbwsoftware_componentCss']) {
    
    document['_vaadintheme_dbwsoftware_componentCss'] = true;
  }
